...
| Register                                         | Address                                 |
+==================================================+=========================================+
| :ref:`TIMER0_LOAD3 <TIMER0_LOAD3>`               | :ref:`0x82002800 <TIMER0_LOAD3>`        |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_LOAD2 <TIMER0_LOAD2>`               | :ref:`0x82002804 <TIMER0_LOAD2>`        |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_LOAD1 <TIMER0_LOAD1>`               | :ref:`0x82002808 <TIMER0_LOAD1>`        |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_LOAD0 <TIMER0_LOAD0>`               | :ref:`0x8200280c <TIMER0_LOAD0>`        |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_RELOAD3 <TIMER0_RELOAD3>`           | :ref:`0x82002810 <TIMER0_RELOAD3>`      |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_RELOAD2 <TIMER0_RELOAD2>`           | :ref:`0x82002814 <TIMER0_RELOAD2>`      |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_RELOAD1 <TIMER0_RELOAD1>`           | :ref:`0x82002818 <TIMER0_RELOAD1>`      |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_RELOAD0 <TIMER0_RELOAD0>`           | :ref:`0x8200281c <TIMER0_RELOAD0>`      |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_EN <TIMER0_EN>`                     | :ref:`0x82002820 <TIMER0_EN>`           |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_UPDATE_VALUE <TIMER0_UPDATE_VALUE>` | :ref:`0x82002824 <TIMER0_UPDATE_VALUE>` |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_VALUE3 <TIMER0_VALUE3>`             | :ref:`0x82002828 <TIMER0_VALUE3>`       |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_VALUE2 <TIMER0_VALUE2>`             | :ref:`0x8200282c <TIMER0_VALUE2>`       |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_VALUE1 <TIMER0_VALUE1>`             | :ref:`0x82002830 <TIMER0_VALUE1>`       |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_VALUE0 <TIMER0_VALUE0>`             | :ref:`0x82002834 <TIMER0_VALUE0>`       |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_EV_STATUS <TIMER0_EV_STATUS>`       | :ref:`0x82002838 <TIMER0_EV_STATUS>`    |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_EV_PENDING <TIMER0_EV_PENDING>`     | :ref:`0x8200283c <TIMER0_EV_PENDING>`   |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER0_EV_ENABLE <TIMER0_EV_ENABLE>`       | :ref:`0x82002840 <TIMER0_EV_ENABLE>`    |
+--------------------------------------------------+-----------------------------------------+
...
`Address: 0x82002800 + 0x20 = 0x82002820`
...
`Address: 0x82002800 + 0x24 = 0x82002824`
...
`Address: 0x82002800 + 0x28 = 0x82002828`
...
`Address: 0x82002800 + 0x2c = 0x8200282c`
...
`Address: 0x82002800 + 0x30 = 0x82002830`
...
`Address: 0x82002800 + 0x34 = 0x82002834`
...
`Address: 0x82002800 + 0x38 = 0x82002838`
...
`Address: 0x82002800 + 0x3c = 0x8200283c`
...
`Address: 0x82002800 + 0x40 = 0x82002840`
