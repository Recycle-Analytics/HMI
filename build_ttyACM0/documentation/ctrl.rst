...
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_SCRATCH3 <CTRL_SCRATCH3>`       | :ref:`0x82000004 <CTRL_SCRATCH3>`    |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_SCRATCH2 <CTRL_SCRATCH2>`       | :ref:`0x82000008 <CTRL_SCRATCH2>`    |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_SCRATCH1 <CTRL_SCRATCH1>`       | :ref:`0x8200000c <CTRL_SCRATCH1>`    |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_SCRATCH0 <CTRL_SCRATCH0>`       | :ref:`0x82000010 <CTRL_SCRATCH0>`    |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_BUS_ERRORS3 <CTRL_BUS_ERRORS3>` | :ref:`0x82000014 <CTRL_BUS_ERRORS3>` |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_BUS_ERRORS2 <CTRL_BUS_ERRORS2>` | :ref:`0x82000018 <CTRL_BUS_ERRORS2>` |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_BUS_ERRORS1 <CTRL_BUS_ERRORS1>` | :ref:`0x8200001c <CTRL_BUS_ERRORS1>` |
+--------------------------------------------+--------------------------------------+
| :ref:`CTRL_BUS_ERRORS0 <CTRL_BUS_ERRORS0>` | :ref:`0x82000020 <CTRL_BUS_ERRORS0>` |
+--------------------------------------------+--------------------------------------+
...
`Address: 0x82000000 + 0xc = 0x8200000c`
...
`Address: 0x82000000 + 0x10 = 0x82000010`
...
`Address: 0x82000000 + 0x14 = 0x82000014`
...
`Address: 0x82000000 + 0x18 = 0x82000018`
...
`Address: 0x82000000 + 0x1c = 0x8200001c`
...
`Address: 0x82000000 + 0x20 = 0x82000020`
