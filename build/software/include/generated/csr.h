...
/* lcd_test */
#define CSR_LCD_TEST_BASE 0x82003800L
#define CSR_LCD_TEST_DATA_ADDR 0x82003800L
#define CSR_LCD_TEST_DATA_SIZE 1
static inline uint8_t lcd_test_DATA_read(void) {
	return csr_read_simple(0x82003800L);
}
static inline void lcd_test_DATA_write(uint8_t v) {
	csr_write_simple(v, 0x82003800L);
}
#define CSR_LCD_TEST_ADDR_ADDR 0x82003804L
#define CSR_LCD_TEST_ADDR_SIZE 1
static inline uint8_t lcd_test_ADDR_read(void) {
	return csr_read_simple(0x82003804L);
}
static inline void lcd_test_ADDR_write(uint8_t v) {
	csr_write_simple(v, 0x82003804L);
}
#define CSR_LCD_TEST_BUSY_ADDR 0x82003808L
#define CSR_LCD_TEST_BUSY_SIZE 1
static inline uint8_t lcd_test_BUSY_read(void) {
	return csr_read_simple(0x82003808L);
}
#define CSR_LCD_TEST_START_ADDR 0x8200380cL
#define CSR_LCD_TEST_START_SIZE 1
static inline uint8_t lcd_test_START_read(void) {
	return csr_read_simple(0x8200380cL);
}
static inline void lcd_test_START_write(uint8_t v) {
	csr_write_simple(v, 0x8200380cL);
}
#define CSR_LCD_TEST_OPTION_ADDR 0x82003810L
#define CSR_LCD_TEST_OPTION_SIZE 1
static inline uint8_t lcd_test_OPTION_read(void) {
	return csr_read_simple(0x82003810L);
}
static inline void lcd_test_OPTION_write(uint8_t v) {
	csr_write_simple(v, 0x82003810L);
}
#define CSR_LCD_TEST_CS__ADDR 0x82003814L
#define CSR_LCD_TEST_CS__SIZE 1
static inline uint8_t lcd_test_CS__read(void) {
	return csr_read_simple(0x82003814L);
}
static inline void lcd_test_CS__write(uint8_t v) {
