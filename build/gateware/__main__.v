//--------------------------------------------------------------------------------
// Auto-generated by Migen (b1b2b29) & LiteX (c3ed8025) on 2020-06-25 20:26:45
//--------------------------------------------------------------------------------
module __main__(
...
wire uart0_rxtx_re;
wire [7:0] uart0_rxtx_r;
wire uart0_rxtx_we;
wire [7:0] uart0_rxtx_w;
wire uart0_txfull_status;
wire uart0_txfull_we;
wire uart0_rxempty_status;
wire uart0_rxempty_we;
wire uart0_irq;
wire uart0_tx_status;
reg uart0_tx_pending = 1'd0;
wire uart0_tx_trigger;
reg uart0_tx_clear = 1'd0;
reg uart0_tx_old_trigger = 1'd0;
wire uart0_rx_status;
reg uart0_rx_pending = 1'd0;
wire uart0_rx_trigger;
reg uart0_rx_clear = 1'd0;
reg uart0_rx_old_trigger = 1'd0;
wire uart0_eventmanager_status_re;
wire [1:0] uart0_eventmanager_status_r;
wire uart0_eventmanager_status_we;
reg [1:0] uart0_eventmanager_status_w = 2'd0;
wire uart0_eventmanager_pending_re;
wire [1:0] uart0_eventmanager_pending_r;
wire uart0_eventmanager_pending_we;
reg [1:0] uart0_eventmanager_pending_w = 2'd0;
reg [1:0] uart0_eventmanager_storage = 2'd0;
reg uart0_eventmanager_re = 1'd0;
wire uart0_uart_sink_valid;
wire uart0_uart_sink_ready;
wire uart0_uart_sink_first;
wire uart0_uart_sink_last;
wire [7:0] uart0_uart_sink_payload_data;
wire uart0_uart_source_valid;
wire uart0_uart_source_ready;
wire uart0_uart_source_first;
wire uart0_uart_source_last;
wire [7:0] uart0_uart_source_payload_data;
wire uart0_tx_fifo_sink_valid;
wire uart0_tx_fifo_sink_ready;
reg uart0_tx_fifo_sink_first = 1'd0;
reg uart0_tx_fifo_sink_last = 1'd0;
wire [7:0] uart0_tx_fifo_sink_payload_data;
wire uart0_tx_fifo_source_valid;
wire uart0_tx_fifo_source_ready;
wire uart0_tx_fifo_source_first;
wire uart0_tx_fifo_source_last;
wire [7:0] uart0_tx_fifo_source_payload_data;
wire uart0_tx_fifo_re;
reg uart0_tx_fifo_readable = 1'd0;
wire uart0_tx_fifo_syncfifo_we;
wire uart0_tx_fifo_syncfifo_writable;
wire uart0_tx_fifo_syncfifo_re;
wire uart0_tx_fifo_syncfifo_readable;
wire [9:0] uart0_tx_fifo_syncfifo_din;
wire [9:0] uart0_tx_fifo_syncfifo_dout;
reg [4:0] uart0_tx_fifo_level0 = 5'd0;
reg uart0_tx_fifo_replace = 1'd0;
reg [3:0] uart0_tx_fifo_produce = 4'd0;
reg [3:0] uart0_tx_fifo_consume = 4'd0;
reg [3:0] uart0_tx_fifo_wrport_adr = 4'd0;
wire [9:0] uart0_tx_fifo_wrport_dat_r;
wire uart0_tx_fifo_wrport_we;
wire [9:0] uart0_tx_fifo_wrport_dat_w;
wire uart0_tx_fifo_do_read;
wire [3:0] uart0_tx_fifo_rdport_adr;
wire [9:0] uart0_tx_fifo_rdport_dat_r;
wire uart0_tx_fifo_rdport_re;
wire [4:0] uart0_tx_fifo_level1;
wire [7:0] uart0_tx_fifo_fifo_in_payload_data;
wire uart0_tx_fifo_fifo_in_first;
wire uart0_tx_fifo_fifo_in_last;
wire [7:0] uart0_tx_fifo_fifo_out_payload_data;
wire uart0_tx_fifo_fifo_out_first;
wire uart0_tx_fifo_fifo_out_last;
wire uart0_rx_fifo_sink_valid;
wire uart0_rx_fifo_sink_ready;
wire uart0_rx_fifo_sink_first;
wire uart0_rx_fifo_sink_last;
wire [7:0] uart0_rx_fifo_sink_payload_data;
wire uart0_rx_fifo_source_valid;
wire uart0_rx_fifo_source_ready;
wire uart0_rx_fifo_source_first;
wire uart0_rx_fifo_source_last;
wire [7:0] uart0_rx_fifo_source_payload_data;
wire uart0_rx_fifo_re;
reg uart0_rx_fifo_readable = 1'd0;
wire uart0_rx_fifo_syncfifo_we;
wire uart0_rx_fifo_syncfifo_writable;
wire uart0_rx_fifo_syncfifo_re;
wire uart0_rx_fifo_syncfifo_readable;
wire [9:0] uart0_rx_fifo_syncfifo_din;
wire [9:0] uart0_rx_fifo_syncfifo_dout;
reg [4:0] uart0_rx_fifo_level0 = 5'd0;
reg uart0_rx_fifo_replace = 1'd0;
reg [3:0] uart0_rx_fifo_produce = 4'd0;
reg [3:0] uart0_rx_fifo_consume = 4'd0;
reg [3:0] uart0_rx_fifo_wrport_adr = 4'd0;
wire [9:0] uart0_rx_fifo_wrport_dat_r;
wire uart0_rx_fifo_wrport_we;
wire [9:0] uart0_rx_fifo_wrport_dat_w;
wire uart0_rx_fifo_do_read;
wire [3:0] uart0_rx_fifo_rdport_adr;
wire [9:0] uart0_rx_fifo_rdport_dat_r;
wire uart0_rx_fifo_rdport_re;
wire [4:0] uart0_rx_fifo_level1;
wire [7:0] uart0_rx_fifo_fifo_in_payload_data;
wire uart0_rx_fifo_fifo_in_first;
wire uart0_rx_fifo_fifo_in_last;
wire [7:0] uart0_rx_fifo_fifo_out_payload_data;
wire uart0_rx_fifo_fifo_out_first;
wire uart0_rx_fifo_fifo_out_last;
...
assign uart0_uart_sink_valid = uart_phy_source_valid;
assign uart_phy_source_ready = uart0_uart_sink_ready;
assign uart0_uart_sink_first = uart_phy_source_first;
assign uart0_uart_sink_last = uart_phy_source_last;
assign uart0_uart_sink_payload_data = uart_phy_source_payload_data;
assign uart_phy_sink_valid = uart0_uart_source_valid;
assign uart0_uart_source_ready = uart_phy_sink_ready;
assign uart_phy_sink_first = uart0_uart_source_first;
assign uart_phy_sink_last = uart0_uart_source_last;
assign uart_phy_sink_payload_data = uart0_uart_source_payload_data;
assign uart0_tx_fifo_sink_valid = uart0_rxtx_re;
assign uart0_tx_fifo_sink_payload_data = uart0_rxtx_r;
assign uart0_txfull_status = (~uart0_tx_fifo_sink_ready);
assign uart0_uart_source_valid = uart0_tx_fifo_source_valid;
assign uart0_tx_fifo_source_ready = uart0_uart_source_ready;
assign uart0_uart_source_first = uart0_tx_fifo_source_first;
assign uart0_uart_source_last = uart0_tx_fifo_source_last;
assign uart0_uart_source_payload_data = uart0_tx_fifo_source_payload_data;
assign uart0_tx_trigger = (~uart0_tx_fifo_sink_ready);
assign uart0_rx_fifo_sink_valid = uart0_uart_sink_valid;
assign uart0_uart_sink_ready = uart0_rx_fifo_sink_ready;
assign uart0_rx_fifo_sink_first = uart0_uart_sink_first;
assign uart0_rx_fifo_sink_last = uart0_uart_sink_last;
assign uart0_rx_fifo_sink_payload_data = uart0_uart_sink_payload_data;
assign uart0_rxempty_status = (~uart0_rx_fifo_source_valid);
assign uart0_rxtx_w = uart0_rx_fifo_source_payload_data;
assign uart0_rx_fifo_source_ready = (uart0_rx_clear | (1'd0 & uart0_rxtx_we));
assign uart0_rx_trigger = (~uart0_rx_fifo_source_valid);
always @(*) begin
	uart0_tx_clear <= 1'd0;
	if ((uart0_eventmanager_pending_re & uart0_eventmanager_pending_r[0])) begin
		uart0_tx_clear <= 1'd1;
	end
end
always @(*) begin
	uart0_eventmanager_status_w <= 2'd0;
	uart0_eventmanager_status_w[0] <= uart0_tx_status;
	uart0_eventmanager_status_w[1] <= uart0_rx_status;
end
always @(*) begin
	uart0_rx_clear <= 1'd0;
	if ((uart0_eventmanager_pending_re & uart0_eventmanager_pending_r[1])) begin
		uart0_rx_clear <= 1'd1;
	end
end
always @(*) begin
	uart0_eventmanager_pending_w <= 2'd0;
	uart0_eventmanager_pending_w[0] <= uart0_tx_pending;
	uart0_eventmanager_pending_w[1] <= uart0_rx_pending;
end
assign uart0_irq = ((uart0_eventmanager_pending_w[0] & uart0_eventmanager_storage[0]) | (uart0_eventmanager_pending_w[1] & uart0_eventmanager_storage[1]));
assign uart0_tx_status = uart0_tx_trigger;
assign uart0_rx_status = uart0_rx_trigger;
assign uart0_tx_fifo_syncfifo_din = {uart0_tx_fifo_fifo_in_last, uart0_tx_fifo_fifo_in_first, uart0_tx_fifo_fifo_in_payload_data};
assign {uart0_tx_fifo_fifo_out_last, uart0_tx_fifo_fifo_out_first, uart0_tx_fifo_fifo_out_payload_data} = uart0_tx_fifo_syncfifo_dout;
assign uart0_tx_fifo_sink_ready = uart0_tx_fifo_syncfifo_writable;
assign uart0_tx_fifo_syncfifo_we = uart0_tx_fifo_sink_valid;
assign uart0_tx_fifo_fifo_in_first = uart0_tx_fifo_sink_first;
assign uart0_tx_fifo_fifo_in_last = uart0_tx_fifo_sink_last;
assign uart0_tx_fifo_fifo_in_payload_data = uart0_tx_fifo_sink_payload_data;
assign uart0_tx_fifo_source_valid = uart0_tx_fifo_readable;
assign uart0_tx_fifo_source_first = uart0_tx_fifo_fifo_out_first;
assign uart0_tx_fifo_source_last = uart0_tx_fifo_fifo_out_last;
assign uart0_tx_fifo_source_payload_data = uart0_tx_fifo_fifo_out_payload_data;
assign uart0_tx_fifo_re = uart0_tx_fifo_source_ready;
assign uart0_tx_fifo_syncfifo_re = (uart0_tx_fifo_syncfifo_readable & ((~uart0_tx_fifo_readable) | uart0_tx_fifo_re));
assign uart0_tx_fifo_level1 = (uart0_tx_fifo_level0 + uart0_tx_fifo_readable);
always @(*) begin
	uart0_tx_fifo_wrport_adr <= 4'd0;
	if (uart0_tx_fifo_replace) begin
		uart0_tx_fifo_wrport_adr <= (uart0_tx_fifo_produce - 1'd1);
	end else begin
		uart0_tx_fifo_wrport_adr <= uart0_tx_fifo_produce;
	end
end
assign uart0_tx_fifo_wrport_dat_w = uart0_tx_fifo_syncfifo_din;
assign uart0_tx_fifo_wrport_we = (uart0_tx_fifo_syncfifo_we & (uart0_tx_fifo_syncfifo_writable | uart0_tx_fifo_replace));
assign uart0_tx_fifo_do_read = (uart0_tx_fifo_syncfifo_readable & uart0_tx_fifo_syncfifo_re);
assign uart0_tx_fifo_rdport_adr = uart0_tx_fifo_consume;
assign uart0_tx_fifo_syncfifo_dout = uart0_tx_fifo_rdport_dat_r;
assign uart0_tx_fifo_rdport_re = uart0_tx_fifo_do_read;
assign uart0_tx_fifo_syncfifo_writable = (uart0_tx_fifo_level0 != 5'd16);
assign uart0_tx_fifo_syncfifo_readable = (uart0_tx_fifo_level0 != 1'd0);
assign uart0_rx_fifo_syncfifo_din = {uart0_rx_fifo_fifo_in_last, uart0_rx_fifo_fifo_in_first, uart0_rx_fifo_fifo_in_payload_data};
assign {uart0_rx_fifo_fifo_out_last, uart0_rx_fifo_fifo_out_first, uart0_rx_fifo_fifo_out_payload_data} = uart0_rx_fifo_syncfifo_dout;
assign uart0_rx_fifo_sink_ready = uart0_rx_fifo_syncfifo_writable;
assign uart0_rx_fifo_syncfifo_we = uart0_rx_fifo_sink_valid;
assign uart0_rx_fifo_fifo_in_first = uart0_rx_fifo_sink_first;
assign uart0_rx_fifo_fifo_in_last = uart0_rx_fifo_sink_last;
assign uart0_rx_fifo_fifo_in_payload_data = uart0_rx_fifo_sink_payload_data;
assign uart0_rx_fifo_source_valid = uart0_rx_fifo_readable;
assign uart0_rx_fifo_source_first = uart0_rx_fifo_fifo_out_first;
assign uart0_rx_fifo_source_last = uart0_rx_fifo_fifo_out_last;
assign uart0_rx_fifo_source_payload_data = uart0_rx_fifo_fifo_out_payload_data;
assign uart0_rx_fifo_re = uart0_rx_fifo_source_ready;
assign uart0_rx_fifo_syncfifo_re = (uart0_rx_fifo_syncfifo_readable & ((~uart0_rx_fifo_readable) | uart0_rx_fifo_re));
assign uart0_rx_fifo_level1 = (uart0_rx_fifo_level0 + uart0_rx_fifo_readable);
always @(*) begin
	uart0_rx_fifo_wrport_adr <= 4'd0;
	if (uart0_rx_fifo_replace) begin
		uart0_rx_fifo_wrport_adr <= (uart0_rx_fifo_produce - 1'd1);
	end else begin
		uart0_rx_fifo_wrport_adr <= uart0_rx_fifo_produce;
	end
end
assign uart0_rx_fifo_wrport_dat_w = uart0_rx_fifo_syncfifo_din;
assign uart0_rx_fifo_wrport_we = (uart0_rx_fifo_syncfifo_we & (uart0_rx_fifo_syncfifo_writable | uart0_rx_fifo_replace));
assign uart0_rx_fifo_do_read = (uart0_rx_fifo_syncfifo_readable & uart0_rx_fifo_syncfifo_re);
assign uart0_rx_fifo_rdport_adr = uart0_rx_fifo_consume;
assign uart0_rx_fifo_syncfifo_dout = uart0_rx_fifo_rdport_dat_r;
assign uart0_rx_fifo_rdport_re = uart0_rx_fifo_do_read;
assign uart0_rx_fifo_syncfifo_writable = (uart0_rx_fifo_level0 != 5'd16);
assign uart0_rx_fifo_syncfifo_readable = (uart0_rx_fifo_level0 != 1'd0);
...
assign uart0_rxtx_r = csr_bankarray_interface5_bank_bus_dat_w[7:0];
assign uart0_rxtx_re = ((csr_bankarray_csrbank5_sel & csr_bankarray_interface5_bank_bus_we) & (csr_bankarray_interface5_bank_bus_adr[2:0] == 1'd0));
assign uart0_rxtx_we = ((csr_bankarray_csrbank5_sel & (~csr_bankarray_interface5_bank_bus_we)) & (csr_bankarray_interface5_bank_bus_adr[2:0] == 1'd0));
...
assign uart0_eventmanager_status_r = csr_bankarray_interface5_bank_bus_dat_w[1:0];
assign uart0_eventmanager_status_re = ((csr_bankarray_csrbank5_sel & csr_bankarray_interface5_bank_bus_we) & (csr_bankarray_interface5_bank_bus_adr[2:0] == 2'd3));
assign uart0_eventmanager_status_we = ((csr_bankarray_csrbank5_sel & (~csr_bankarray_interface5_bank_bus_we)) & (csr_bankarray_interface5_bank_bus_adr[2:0] == 2'd3));
assign uart0_eventmanager_pending_r = csr_bankarray_interface5_bank_bus_dat_w[1:0];
assign uart0_eventmanager_pending_re = ((csr_bankarray_csrbank5_sel & csr_bankarray_interface5_bank_bus_we) & (csr_bankarray_interface5_bank_bus_adr[2:0] == 3'd4));
assign uart0_eventmanager_pending_we = ((csr_bankarray_csrbank5_sel & (~csr_bankarray_interface5_bank_bus_we)) & (csr_bankarray_interface5_bank_bus_adr[2:0] == 3'd4));
...
assign csr_bankarray_csrbank5_txfull_w = uart0_txfull_status;
assign uart0_txfull_we = csr_bankarray_csrbank5_txfull_we;
assign csr_bankarray_csrbank5_rxempty_w = uart0_rxempty_status;
assign uart0_rxempty_we = csr_bankarray_csrbank5_rxempty_we;
assign csr_bankarray_csrbank5_ev_enable0_w = uart0_eventmanager_storage[1:0];
...
assign csr_bankarray_csrbank6_tuning_word3_w = uart_phy_storage[31:24];
assign csr_bankarray_csrbank6_tuning_word2_w = uart_phy_storage[23:16];
assign csr_bankarray_csrbank6_tuning_word1_w = uart_phy_storage[15:8];
assign csr_bankarray_csrbank6_tuning_word0_w = uart_phy_storage[7:0];
...
assign uart_phy_rx = xilinxmultiregimpl2_regs1;
...
always @(posedge sys_clk) begin
	...
	if (uart_phy_tx_busy) begin
		...
		{uart_phy_uart_clk_txen, uart_phy_phase_accumulator_tx} <= uart_phy_storage;
	end
	...
	if (uart0_tx_clear) begin
		uart0_tx_pending <= 1'd0;
	end
	uart0_tx_old_trigger <= uart0_tx_trigger;
	if (((~uart0_tx_trigger) & uart0_tx_old_trigger)) begin
		uart0_tx_pending <= 1'd1;
	end
	if (uart0_rx_clear) begin
		uart0_rx_pending <= 1'd0;
	end
	uart0_rx_old_trigger <= uart0_rx_trigger;
	if (((~uart0_rx_trigger) & uart0_rx_old_trigger)) begin
		uart0_rx_pending <= 1'd1;
	end
	if (uart0_tx_fifo_syncfifo_re) begin
		uart0_tx_fifo_readable <= 1'd1;
	end else begin
		if (uart0_tx_fifo_re) begin
			uart0_tx_fifo_readable <= 1'd0;
		end
	end
	if (((uart0_tx_fifo_syncfifo_we & uart0_tx_fifo_syncfifo_writable) & (~uart0_tx_fifo_replace))) begin
		uart0_tx_fifo_produce <= (uart0_tx_fifo_produce + 1'd1);
	end
	if (uart0_tx_fifo_do_read) begin
		uart0_tx_fifo_consume <= (uart0_tx_fifo_consume + 1'd1);
	end
	if (((uart0_tx_fifo_syncfifo_we & uart0_tx_fifo_syncfifo_writable) & (~uart0_tx_fifo_replace))) begin
		if ((~uart0_tx_fifo_do_read)) begin
			uart0_tx_fifo_level0 <= (uart0_tx_fifo_level0 + 1'd1);
		end
	end else begin
		if (uart0_tx_fifo_do_read) begin
			uart0_tx_fifo_level0 <= (uart0_tx_fifo_level0 - 1'd1);
	...
	if (uart0_rx_fifo_syncfifo_re) begin
		uart0_rx_fifo_readable <= 1'd1;
	end else begin
		if (uart0_rx_fifo_re) begin
			uart0_rx_fifo_readable <= 1'd0;
		end
	end
	if (((uart0_rx_fifo_syncfifo_we & uart0_rx_fifo_syncfifo_writable) & (~uart0_rx_fifo_replace))) begin
		uart0_rx_fifo_produce <= (uart0_rx_fifo_produce + 1'd1);
	end
	if (uart0_rx_fifo_do_read) begin
		uart0_rx_fifo_consume <= (uart0_rx_fifo_consume + 1'd1);
	end
	if (((uart0_rx_fifo_syncfifo_we & uart0_rx_fifo_syncfifo_writable) & (~uart0_rx_fifo_replace))) begin
		if ((~uart0_rx_fifo_do_read)) begin
			uart0_rx_fifo_level0 <= (uart0_rx_fifo_level0 + 1'd1);
		end
	end else begin
		if (uart0_rx_fifo_do_read) begin
			uart0_rx_fifo_level0 <= (uart0_rx_fifo_level0 - 1'd1);
	...
	if (csr_bankarray_csrbank5_sel) begin
		case (csr_bankarray_interface5_bank_bus_adr[2:0])
			1'd0: begin
				csr_bankarray_interface5_bank_bus_dat_r <= uart0_rxtx_w;
			end
			1'd1: begin
			...
			2'd3: begin
				csr_bankarray_interface5_bank_bus_dat_r <= uart0_eventmanager_status_w;
			end
			3'd4: begin
				csr_bankarray_interface5_bank_bus_dat_r <= uart0_eventmanager_pending_w;
			end
			3'd5: begin
	...
	if (csr_bankarray_csrbank5_ev_enable0_re) begin
		uart0_eventmanager_storage[1:0] <= csr_bankarray_csrbank5_ev_enable0_r;
	end
	uart0_eventmanager_re <= csr_bankarray_csrbank5_ev_enable0_re;
	...
	if (csr_bankarray_csrbank6_tuning_word3_re) begin
		uart_phy_storage[31:24] <= csr_bankarray_csrbank6_tuning_word3_r;
	end
	if (csr_bankarray_csrbank6_tuning_word2_re) begin
		uart_phy_storage[23:16] <= csr_bankarray_csrbank6_tuning_word2_r;
	end
	if (csr_bankarray_csrbank6_tuning_word1_re) begin
		uart_phy_storage[15:8] <= csr_bankarray_csrbank6_tuning_word1_r;
	end
	if (csr_bankarray_csrbank6_tuning_word0_re) begin
		uart_phy_storage[7:0] <= csr_bankarray_csrbank6_tuning_word0_r;
	end
	uart_phy_re <= csr_bankarray_csrbank6_tuning_word0_re;
	if (sys_rst) begin
		...
		uart_phy_rx_busy <= 1'd0;
		uart0_tx_pending <= 1'd0;
		uart0_tx_old_trigger <= 1'd0;
		uart0_rx_pending <= 1'd0;
		uart0_rx_old_trigger <= 1'd0;
		uart0_eventmanager_storage <= 2'd0;
		uart0_eventmanager_re <= 1'd0;
		uart0_tx_fifo_readable <= 1'd0;
		uart0_tx_fifo_level0 <= 5'd0;
		uart0_tx_fifo_produce <= 4'd0;
		uart0_tx_fifo_consume <= 4'd0;
		uart0_rx_fifo_readable <= 1'd0;
		uart0_rx_fifo_level0 <= 5'd0;
		uart0_rx_fifo_produce <= 4'd0;
		uart0_rx_fifo_consume <= 4'd0;
	...
	xilinxmultiregimpl2_regs0 <= uart0_rx;
...
reg [9:0] memdat_6;
always @(posedge sys_clk) begin
	if (uart0_tx_fifo_wrport_we)
		storage_3[uart0_tx_fifo_wrport_adr] <= uart0_tx_fifo_wrport_dat_w;
	memdat_5 <= storage_3[uart0_tx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (uart0_tx_fifo_rdport_re)
		memdat_6 <= storage_3[uart0_tx_fifo_rdport_adr];
end

assign uart0_tx_fifo_wrport_dat_r = memdat_5;
assign uart0_tx_fifo_rdport_dat_r = memdat_6;

reg [9:0] storage_4[0:15];
reg [9:0] memdat_7;
reg [9:0] memdat_8;
always @(posedge sys_clk) begin
	if (uart0_rx_fifo_wrport_we)
		storage_4[uart0_rx_fifo_wrport_adr] <= uart0_rx_fifo_wrport_dat_w;
	memdat_7 <= storage_4[uart0_rx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (uart0_rx_fifo_rdport_re)
		memdat_8 <= storage_4[uart0_rx_fifo_rdport_adr];
end

assign uart0_rx_fifo_wrport_dat_r = memdat_7;
assign uart0_rx_fifo_rdport_dat_r = memdat_8;
