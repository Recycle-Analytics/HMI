...
################################################################################
# serial:0.tx
set_property LOC G3 [get_ports {serial_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {serial_tx}]

# serial:0.rx
set_property LOC F3 [get_ports {serial_rx}]
...
# uart0:0.tx
set_property LOC D4 [get_ports {uart00_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart00_tx}]

# uart0:0.rx
set_property LOC C4 [get_ports {uart00_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart00_rx}]
